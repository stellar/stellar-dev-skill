...
// GitHub mark is a filled glyph, so it overrides the stroke-based defaults
// from baseProps and paints with `currentColor` fill instead.
export const GitHubIcon = (props: IconProps) => (
  <svg {...baseProps} stroke="none" fill="currentColor" {...props}>
